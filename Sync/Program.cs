...
namespace ProvisionDeprovision
{
    class Program
    {
        ...
        private static string cloudConnectionString = "Server=mocato-sqls-stride-dev.database.windows.net;Database=carlo-test-mocato-db-stride-dev_20240427_1013ET;";
